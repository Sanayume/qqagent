...
CONFIG_SCHEMA = [
    {
        ...
        "fields": [
            ...
            {"key": "cors_origins", "label": "CORS Origins", "type": "string_list", "help": "Allowed browser origins."},
            {"key": "allow_query_token", "label": "Allow HTTP Query Token", "type": "bool", "help": "Allow token= for HTTP API calls."},
        ],
    },
    {
        "key": "onebot",
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "monitor.max_buffer_messages", "label": "Max Buffer Messages", "type": "int", "help": "Maximum TG messages kept per flush window."},
            {"key": "monitor.dedupe_seconds", "label": "Dedupe Seconds", "type": "float", "help": "Skip duplicate TG messages within this window."},
            {"key": "monitor.store_raw", "label": "Store Raw", "type": "bool", "help": "Persist raw TG messages under data/tg_news."},
            {"key": "monitor.persona_prompt", "label": "Persona Prompt Override", "type": "textarea", "help": "Optional style override for TG summaries."},
